...
public class ChangeMakerTestHarness {
   ...
   */
   public static void main( String[] args ) {
      ...
      test_PolishGroszi();     // Grosz is 100th Zloty: 1, 2, 5, 10, 20, 50, 100, 200, 500 gr
                               //   the last three are 1, 2, and 5 Zloti coins

      test_createRandomTuple();
   ...
   */
   ...
   public static void test_PolishGroszi() {

      int[] groszDenominations  = new int[] { 1, 2, 5, 10, 20, 50, 100, 200, 500 };
      Tuple result = null;

      System.out.println( "\n\n  TESTING TO FIND OPTIMAL SOLUTION TO MAKING 99 cents USING GROSZI" );
      System.out.println( "  ================================================================" );

      System.out.println( "\n    Test " + makeTwoDigits() + ": testing optimal solution for 99 grosz: " );
      result = ChangeMaker.makeChangeWithDynamicProgramming( groszDenominations, 99 );
      try {
        System.out.print( "      expecting Tuple: <0,2,1,0,2,1,0,0,0>: " );
        displaySuccessIfTrue( "<0,2,1,0,2,1,0,0,0>".equals( result.toString() ) ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
   ...
   public static void test_createRandomTuple() {

      System.out.println( "\n\n  TESTING RANDOM TUPLE GENERATION FOR THREE BOGUS DENOMINATION SETS" );
      System.out.println( "  =================================================================" );

      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 7, true ) + ": " );
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 7, false ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 2, true ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 17, false ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 11, true ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 23, false ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 3, true ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      ...
      try {
         System.out.print( "\n    Test " + makeTwoDigits() + " creating random tuple: " + randomTuple( 5, false ) + ": " );
         displaySuccessIfTrue( true ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
